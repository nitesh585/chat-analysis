...
def Contacts_less_than_5(filename):
    ...
    top_active = plt.subplot(fig[4:6, 2:])
    ...
    wordcloud = WordCloud(width=1400, height=800,
                        ...
                        max_font_size=100,
                        colormap='plasma',
                        max_words=250).generate(comment_words)
